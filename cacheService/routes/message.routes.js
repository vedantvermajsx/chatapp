...
import { getRoomMessageByIdController } from '../controllers/message/getRoomMessageById.controller.js';
...
router.get('/room/:roomId/msg/:messageId', getRoomMessageByIdController);
